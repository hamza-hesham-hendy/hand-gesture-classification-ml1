...
Uses the MediaPipe Tasks API (HandLandmarker) to extract 21 hand landmarks
from video frames, normalize them for model inference, draw the hand skeleton
overlay, and smooth per-frame predictions with a rolling-mode window.
"""
